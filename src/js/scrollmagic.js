...
SM.parallax = function () {
    ...
    let mapBoxID = $("#o-map");
    let videoBoxID = $("#o-video-boxes");
    let mediaBoxID = $("#o-media-boxes");
    let contactBoxID = $("#o-p-contact__body");
    let parallaxBoxID = $("#o-parallax-parent");

    if (mapBoxID.length !== 0) {
